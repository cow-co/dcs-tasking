...
public class TaskingControllerTests {
        ...
        public void testAssignsUser() throws Exception {
                ...
                long id = ((Number) JsonPath.read(created.getResponse().getContentAsString(), "tasking.id"))
                                .longValue();
                MvcResult response = mockMvc.perform(post("/api/v1/taskings/" + id + "/assign/player1")).andReturn();
                ...
                response = mockMvc.perform(post("/api/v1/taskings/" + id + "/assign/player2"))
        ...
        public void testAssignsUserDuplicate() throws Exception {
                ...
                long id = ((Number) JsonPath.read(created.getResponse().getContentAsString(), "tasking.id"))
                                .longValue();
                mockMvc.perform(post("/api/v1/taskings/" + id + "/assign/player1"));
                MvcResult response = mockMvc.perform(post("/api/v1/taskings/" + id + "/assign/player1")).andReturn();
